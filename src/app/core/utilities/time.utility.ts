...
export const addMinutesToDate = (date: Date, minutesToAdd: number): Date => {
    ...
    if (newDate.getMonth() !== currentDate.getMonth()) {
        if (
            (newDate.getMonth() === 0 && currentDate.getMonth() === 11)
      || newDate.getMonth() > currentDate.getMonth()
        ) {
            throw ("New Time Will be Out of Range");
        }
        if (
            (newDate.getMonth() === 11 && currentDate.getMonth() === 0)
      || newDate.getMonth() < currentDate.getMonth()
        ) {
            throw ("New Time Will be Out of Range");
        }
...
export const areDatesEqual = (date1: Date, date2: Date): boolean => date1.getDate() === date2.getDate()
